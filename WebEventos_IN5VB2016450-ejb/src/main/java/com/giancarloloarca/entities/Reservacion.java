...
public class Reservacion implements Serializable {
    ...
    public Reservacion(Integer idreservacion, Date fecha, Date horainicio, Date horafin, String descripcion) {
        this.idreservacion = idreservacion;
        this.fecha = fecha;
    ...
    public String toString() {
        return "com.giancarloloarca.entities.Reservacion[ idreservacion=" + idreservacion + " ]";
    }
